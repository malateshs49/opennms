...
public class EventdConfigManager implements EventdConfig {
	...
	private void reload() throws IOException {
		try (final Reader r = new FileReader(
				ConfigFileConstants.getFile(ConfigFileConstants.EVENTD_CONFIG_FILE_NAME))) {
	 ...
	 *
	 * @return the maximum number of events that can be stored in the incoming event
	 *         queue
	 */
	 ...
	 *
	 * @deprecated This is only used when using {@link JdbcEventWriter} so when we
	 *             remove the JDBC implementation, we can get rid of this class.
	 * 
	 * @return the SQL statement to get the next event ID
	 */
